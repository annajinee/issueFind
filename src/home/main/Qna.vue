        ...
        <section class="text-white mt-5" id="about">
            <div class="container">
                <div class="row justify-content-center">
                        <btn class="mt-0 btn-danger btn-lg">유료 서비스팩 이용 시 최신 정보 및 추이 그래프를 받아 보실 수 있습니다. <i class="fas fa-comment-dollar"></i></btn>
                </div>
            </div>
        </section>
                ...
                <div class="row text-center">
                    <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <a class="btn btn-outline-dark col-md-12" href="#about">인증번호 받기</a>
                            </div>
                        </div>
                        <div class="m-3">
                        ...
                        <a class="btn btn-danger btn-lg js-scroll-trigger m-2 col-md-5" href="#about">문의하기</a>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <h4 class="mb-5" style="color: #61380B">국내 2,300여개의 기업정보를 한눈에!</h4>
                        <h2 class="mt-1 color-red font-weight-bold">1DAY – 4,600원</h2>
                        <p class="mb-">(1년 이용 시 할인가)</p>
                        <a class="btn btn-dark btn-lg js-scroll-trigger text-center m-4"
